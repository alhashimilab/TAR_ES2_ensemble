...
foldername1 = [name for name in os.listdir(path) if os.path.isdir(os.path.join(path, name))]
foldername = [name for name in foldername1 if name[:5] == 'test_']
...
kex_foldername = [name for name in foldername if name.split('_')[1][0] == 'k']
pb_foldername = [name for name in foldername if name.split('_')[1][0] == 'p']
dw_foldername = [name for name in foldername if  name.split('_')[1][0] == 'd']

print(kex_foldername)
# In[3]:
